...
config.General.requestName = 'doublemuon2015D_02Oct'
...
config.Data.publishDataName = 'B2GAnaFW_v74x_v7p1_25ns'
config.Data.outLFNDirBase = '/store/user/devdatta/B2GAnaFW/DoubleMuon/Run2015D-PromptReco-v3' 
config.Data.outLFNDirBase = '/store/group/phys_b2g/B2GAnaFW/'
