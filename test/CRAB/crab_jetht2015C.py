...
config.General.requestName = 'jetht2015C'
config.General.workArea = 'B2GAnaFW_v74x_V7'
...
config.Data.publishDataName = 'B2GAnaFW_v74x_V7'
config.Data.outLFNDirBase = '/store/user/devdatta/B2GAnaFW/JetHT/Run2015D-PromptReco-v3' 
